...
//源路径
struct hanr_src_path{
    uint32_t src_client_ipv4;
    uint32_t src_T2_ipv4;
    uint32_t src_T1_ipv4;
    uint32_t src_T0_ipv4;
    uint8_t src_client_ipv6[16];
    uint8_t src_T2_ipv6[16];
    uint8_t src_T1_ipv6[16];
    uint8_t src_T0_ipv6[16];
};
